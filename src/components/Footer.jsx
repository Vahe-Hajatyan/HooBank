...
const Footer = () => (
  ...
  >
          ...
          >
            ...
            <ul className="list-none mt-4">
              {footerLink.links.map((link, index) => (
                <li
                  key={link.name}
                  className={`font-poppins font-normal text-[16px] leading-[24px] text-dimWhite cursor-pointer hover:text-secondary hover:ease-out ${
    ...
    <div className="absolute z-[0] -left-[50%] w-[70%] h-[60%] rounded-full pink__gradient" />
  </section>
);
